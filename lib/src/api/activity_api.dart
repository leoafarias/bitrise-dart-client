...
class ActivityApi {
  ...
  Future<Response<V0ActivityEventListResponseModel>> activityList({ 
    String? next,
    int? limit,
    ...
    V0ActivityEventListResponseModel _responseData;

    try {
      const _responseType = FullType(V0ActivityEventListResponseModel);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as V0ActivityEventListResponseModel;
    ...
    return Response<V0ActivityEventListResponseModel>(
      data: _responseData,
